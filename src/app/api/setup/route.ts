...
DO $$ BEGIN
  CREATE TYPE "ShiftType" AS ENUM ('DAY', 'NIGHT', 'OFF', 'VACATION', 'SICK', 'TRAINING', 'SHUTDOWN');
EXCEPTION WHEN duplicate_object THEN null; END $$;
...
DO $$ BEGIN
  ALTER TABLE "User" ADD CONSTRAINT "User_crewId_fkey" FOREIGN KEY ("crewId") REFERENCES "Crew"("id") ON DELETE SET NULL;
EXCEPTION WHEN duplicate_object THEN null; END $$;
